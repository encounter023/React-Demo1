...
var GalleryByReactApp = React.createClass({
	...
	*/
    ...
    var stageDOM = this.refs.stage,
        ...
        //拿到一个imageFigure的大小
        //var imgFigureDom = React.FindDomNode(this.refs.ImagFigure0);
	...
	render: function(){
		...
		imageDatas.forEach(function (value,index){
			...
			imageFigures.push(<ImgFigure data={value} ref={'imgFigure' + index} 
				key = {index} arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} 
